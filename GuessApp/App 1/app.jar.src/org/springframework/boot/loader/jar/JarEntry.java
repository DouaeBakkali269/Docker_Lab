...
/*  46 */     super((nameAlias != null) ? nameAlias.toString() : header.getName().toString());
/*  47 */     this.name = (nameAlias != null) ? nameAlias : header.getName();
...
/* Location:              C:\Users\Usuario\Downloads\Lab001\GuessApp\App 1\app.jar!\org\springframework\boot\loader\jar\JarEntry.class
